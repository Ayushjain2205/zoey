  ...
  return (
    <StyledView className="flex-1 bg-[#E0B3FF] items-center justify-center space-y-8">
      <Image
        ...
        resizeMode="contain"
      />
      <StyledText className="text-5xl text-center font-[RubikDoodleShadow] text-black border-2 border-black rounded-xl px-6 py-2 shadow-[5px_5px_0px_0px_rgba(0,0,0,1)] active:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] active:translate-x-[3px] active:translate-y-[3px]">
        Zoey
      </StyledText>
    </StyledView>
  );
